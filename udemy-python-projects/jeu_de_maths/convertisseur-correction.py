...
2 - Demander à l'utilisateur de rentrer la valeur à convertiren reprÃ©cisant l'unité)
3 - Afficher la valeur convertieet l'unité : cm ou pouces)
- fin du programme.
"""
...
Return :
 True : L'utilisateur ne veut plus convertirsortir du programme)
...
def demander_et_afficher_conversion(unit1: str, unit2: str, facteur: float):
    ...
    try:
        ...
        print("(utilisez le point et non la virgule pour les dÃ©cimales)")
